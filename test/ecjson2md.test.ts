    ...
    describe("Schema markdown generation", () => {
      ...
      describe("writeFrontMatter", () => {
        ...
        it("should correctly write the front matter without an alert", () => {
          ...
          assert.equal(outputLines[1], "noEditThisPage: true");
          assert.equal(outputLines[2], "Schema: testSchema");
          assert.equal(outputLines[3], "This file was automatically generated via ecjson2md. Do not edit this file. Any edits made to this file will be overwritten the next time it is generated");
        ...
        it("should correctly write the front matter with an alert", () => {
          ...
          assert.equal(outputLines[4], "---");
          assert.equal(outputLines[5], "");
          assert.equal(outputLines[6], '[!alert text="This documentation represents a nonreleased version of this schema" kind="warning"]');
          assert.equal(outputLines[7], "");
          assert.equal(outputLines[8], "");
        });
      });
