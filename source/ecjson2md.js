...
var ECJsonMarkdown = /** @class */ (function () {
     ...
     */
    ECJsonMarkdown.prototype.loadJsonSchema = function (schema, outputFile) {
        var _this = this;
        var schemaPromise = ecjs_1.Schema.fromJson(schema, this.context);
        schemaPromise.then(function (result) { return __awaiter(_this, void 0, void 0, function () {
